                ...
                <div class="main-menu">
                    <div class="navbar navbar-cus">
                        <div class="navbar-header">
                            <a href="/" class="navbar-brand"><span class="logo">smart</span></a> <!--edit site name here-->
                        ...
                        <div class="navbar-collapse collapse">
                            <nav>
                                <ul class="nav navbar-nav navbar-right">
                                    ...
                                    <li><a class="smooth-menu" href="#about">О компании</a></li>
                                    <li><a class="smooth-menu" href="#services">Услуги</a></li>
                                    <li><a class="smooth-menu" href="#portfolio">Наши работы</a></li>
                                    <li><a class="smooth-menu" href="#testimonial">Отзывы</a></li>
                                    <li><a class="smooth-menu" href="#contact">Контакты</a></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <section class="intro animate-scale">
                                ...
                                <h3>Добро пожаловать на сайт компании SMART</h3>

                                <h1 class="ah-headline">

                                        <span class="ah-words-wrapper">
                                            <b class="is-visible">Разработка</b> <!--edit the name to your name-->
                                            <b>Наполнение</b> <!--edit the designation if you are in different profession-->
                                            <b>Поддержка</b> <!--edit the designation if you are in different profession-->
                                            <b>Уникальные технологии</b> <!--edit the designation if you are in different profession-->
                                        </span>
                                </h1>

                                <a href="#services" class="banner-btn">подробнее</a>
        ...
        <div class="row">
            <div class="col-md-4 col-xs-12 col-sm-6 col-lg-4">
                <div class="about-text-left">
                    <h2>Mason Smith</h2> <!--edit name-->
                    <h3>Full Stack Developer</h3> <!--edit designation-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="skillbar" data-percent="75%"> <!--edit percentage-->
                                    ...
                                    <h6 class="skillbar-title">JOOMLA</h6> <!--edit skills-->
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="skillbar" data-percent="70%"> <!--edit percentage-->
                                    ...
                                    <h6 class="skillbar-title">DRUPAL</h6> <!--edit skills-->
                    ...
                    <div id="inline-popups" class="port-box">
                        <a href="#test-popup" data-effect="mfp-zoom-out">
                            <div class="hovereffect">
                                ...
                                <img src="images/portfolio/port1.png" alt="portfolio image" class="img-responsive"> <!--edit image-->
                                <div class="overlay">
                    ...
                    <div id="inline-popups-2">
                        <a href="#test-popup-2" data-effect="mfp-zoom-out">
                            <div class="hovereffect">
                                ...
                                <img src="images/portfolio/port2.png" alt="portfolio image" class="img-responsive"> <!--edit image-->
                                <div class="overlay">
                                    <h2>Project Two</h2> <!--your project name-->
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. A, dolores, velit. Accusantium mollitia obcaecati quos.</p>
                                </div>
                                ...
                                <div class="por-text">
                                    ...
                                    <div class="por-text-details">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-offset-1 col-xs-7">
                                                <p>SportsDirect</p> <!--edit here-->
                                                <p>15/03/2018</p> <!--edit here-->
                                                <p>Joomla Site</p> <!--edit here-->
                                                <p>www.sportsdirect.com</p> <!--edit here-->
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div id="inline-popups-3">
                        <a href="#test-popup-3" data-effect="mfp-zoom-out">
                            <div class="hovereffect">
                                ...
                                <img src="images/portfolio/port3.png" alt="portfolio image" class="img-responsive"> <!--edit image-->
                                <div class="overlay">
                    ...
                    <div id="inline-popups-4">
                        <a href="#test-popup-4" data-effect="mfp-zoom-out">
                            <div class="hovereffect">
                                ...
                                <img src="images/portfolio/port4.png" alt="portfolio image" class="img-responsive"> <!--edit image-->
                                <div class="overlay">
                                ...
                                <div class="por-text">
                                    ...
                                    <div class="por-text-details">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-offset-1 col-xs-7">
                                                <p>Woolworths</p> <!--edit here-->
                                                <p>25/03/2018</p> <!--edit here-->
                ...
                <div class="review-area">
                    <div id="testimonial-carousel" class="owl-carousel owl-theme">
                        <div class="single-testi text-center item">
                            <div class="testi-img">
                                <img src="images/testimonial/testi-1.png" alt="testimonial image"> <!--edit image-->
                            </div>
                        ...
                        <div class="single-testi text-center item">
                            <div class="testi-img">
                                <img src="images/testimonial/testi-2.png" alt="testimonial image"> <!--edit image-->
                            </div>
                            <div class="block-quote">
                                <p>My Experience working with Mason has been very positive. I always receive quality service from him. I highly recommend this guy to everyone because I think he is one a of kind.</p> <!--edit here-->
                        ...
                        <div class="single-testi text-center item">
                            <div class="testi-img">
                                <img src="images/testimonial/testi-3.png" alt="testimonial image"> <!--edit image-->
                            </div>
                            <div class="block-quote">
                                <p>My Experience working with Mason has been very positive. I always receive quality service from him. I highly recommend this guy to everyone because I think he is one a of kind.</p> <!--edit here-->
